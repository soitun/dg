...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Animator', fields ['gender', 'name', 'partner']
        db.create_unique(u'animator', ['GENDER', 'NAME', 'partner_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Animator', fields ['gender', 'name', 'partner']
        db.delete_unique(u'animator', ['GENDER', 'NAME', 'partner_id'])
        ...
        # Adding field 'Video.movie_maker_project_filename'
        db.add_column(u'video', 'movie_maker_project_filename',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, db_column='MOVIE_MAKER_PROJECT_FILENAME', blank=True),
                      keep_default=False)

        # Adding field 'Video.last_modified'
        db.add_column(u'video', 'last_modified',
        ...
        # Adding field 'Video.final_edited_filename'
        db.add_column(u'video', 'final_edited_filename',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, db_column='FINAL_EDITED_FILENAME', blank=True),
                      keep_default=False)

        # Adding field 'Video.editing_quality'
        db.add_column(u'video', 'editing_quality',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, db_column='EDITING_QUALITY', blank=True),
                      keep_default=False)

        # Adding field 'Video.raw_filename'
        db.add_column(u'video', 'raw_filename',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, db_column='RAW_FILENAME', blank=True),
                      keep_default=False)

        # Adding field 'Video.audio_quality'
        db.add_column(u'video', 'audio_quality',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, db_column='AUDIO_QUALITY', blank=True),
                      keep_default=False)

        # Adding field 'Video.remarks'
        db.add_column(u'video', 'remarks',
                      self.gf('django.db.models.fields.TextField')(default=None, db_column='REMARKS', blank=True),
                      keep_default=False)
        ...
        db.add_column(u'video', 'storybase',
                      self.gf('django.db.models.fields.IntegerField')(default=None, max_length=1, db_column='STORYBASE'),
                      keep_default=False)

        # Adding field 'Video.storyboard_filename'
        db.add_column(u'video', 'storyboard_filename',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, db_column='STORYBOARD_FILENAME', blank=True),
                      keep_default=False)

        # Adding field 'Video.picture_quality'
        db.add_column(u'video', 'picture_quality',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, db_column='PICTURE_QUALITY', blank=True),
                      keep_default=False)

        # Adding field 'Video.thematic_quality'
        db.add_column(u'video', 'thematic_quality',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, db_column='THEMATIC_QUALITY', blank=True),
                      keep_default=False)
        ...
        db.add_column(u'animator', 'address',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=500, db_column='ADDRESS', blank=True),
                      keep_default=False)
        ...
        db.add_column(u'village', 'road_connectivity',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, db_column='ROAD_CONNECTIVITY', blank=True),
                      keep_default=False)
        ...
        db.add_column(u'screening', 'location',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, db_column='LOCATION', blank=True),
                      keep_default=False)
