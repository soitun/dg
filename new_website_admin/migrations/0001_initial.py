...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Member'
        db.create_table('new_website_admin_member', (
        ...
        db.send_create_signal('new_website_admin', ['Member'])


    def backwards(self, orm):
        # Deleting model 'Member'
        db.delete_table('new_website_admin_member')


    models = {
        'new_website_admin.member': {
    ...
    complete_apps = ['new_website_admin']